...
#define GIMBAL_PITCH_MAX_LIMIT_DEG           170.0f

// 如果pitch正速度会让镜头向下运动，则将该宏改为-1.0f
#define GIMBAL_PITCH_POSITIVE_SPEED_IS_UP      1.0f
// 距离软限位小于该角度时停止继续向外转动，单位deg
#define GIMBAL_PITCH_LIMIT_STOP_MARGIN_DEG     1.0f
// 靠近软限位时的降速系数，单位rpm/deg
#define GIMBAL_PITCH_LIMIT_SPEED_GAIN          3.0f
// pitch轴软件限速，防止视觉PID输出过大速度，单位rpm
#define GIMBAL_PITCH_MAX_SPEED_RPM           180.0f
